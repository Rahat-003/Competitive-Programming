...
node* insertCircularLinkedList(node* root,int val)
{
...
//
//    cout<<val<<endl;
    while(currentNode->nextNode!=root)
    {
//        cout<<"asfd"<<endl;
...
//    cout<<currentNode->data<<" "<<temp->data<<" "<<endl;
    return root;
}
...
//read;
    ...
    for(int i=0;i<n;i++)
    {
        int x;
        cin>>x;
        root=insertCircularLinkedList(root,x);
    }
//    traverse(root);
